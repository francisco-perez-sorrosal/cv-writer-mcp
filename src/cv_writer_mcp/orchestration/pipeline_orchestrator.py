...
from ..utils import ProgressMapper, report_progress
...
class CVPipelineOrchestrator:
    ...
    async def generate_cv_from_markdown(
        ...
        try:
            ...
            await report_progress(5, progress_callback, "Starting conversion")
            ...
            await report_progress(30, progress_callback, "Conversion complete")
            ...
            await report_progress(35, progress_callback, "Preparing compilation")
            ...
            await report_progress(60, progress_callback, "Compilation successful")
            ...
            if enable_style_improvement:
                ...
                await report_progress(65, progress_callback, "Starting style improvement")
            ...
            await report_progress(95, progress_callback, "Finalizing")
    ...
    async def compile_and_improve_style(
        ...
        try:
            ...
            await report_progress(5, progress_callback, "Starting pipeline")

            # Locate tex file
            tex_path = self.config.output_dir / tex_filename

            await report_progress(10, progress_callback, "Locating LaTeX file")
            ...
            await report_progress(15, progress_callback, "Preparing compilation")
            ...
            await report_progress(50, progress_callback, "Compilation successful")
            ...
            await report_progress(55, progress_callback, "Starting style improvement")
